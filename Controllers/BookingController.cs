...
namespace VenueBookingSystem.Controllers
{
    public class BookingController : Controller
    {
        ...
        public BookingController(VenueBookingContext context)
        {
            _context = context;
        }
        ...
        {
            var venueBookingContext = _context.Bookings.Include(b => b.Event).Include(b => b.Venue);
            return View(await venueBookingContext.ToListAsync());
        }
